...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		this.background(600, 200, 200);
		
		// Select a map provider
		AbstractMapProvider provider = new Google.GoogleTerrainProvider();
		AbstractMapProvider providerAlter = new Microsoft.HybridProvider();
		// Set a zoom level
		int zoomLevel = 10;
		...
		map1 = new UnfoldingMap(this, 0, 0, 350, 500, providerAlter);
		map2 = new UnfoldingMap(this, 450, 50, 350, 500, providerAlter);

		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
	    map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
	    map2.zoomAndPanTo(zoomLevel, new Location(54.9, -1.6));
